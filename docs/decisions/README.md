...
This directory records the non-obvious Phase 0 and Phase 1 decisions that must
survive beyond an individual development session. The records describe durable
contracts and their rationale; they do not contain hidden model reasoning,
