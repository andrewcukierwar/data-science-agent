...
CANONICAL_PROFITABILITY_SCENARIO = ScenarioDefinition(
    ...
    ground_truth=(
        GroundTruthMetric(
            ...
            description="Meta Q2 converted-session rate versus the clean baseline.",
            comparison="scenario_meta_q2_conversion_vs_clean_baseline",
            expected_relative_change=-0.18,
            tolerance=0.01,
        ),
        GroundTruthMetric(
            id="meta-q2-acquired-customers",
            description="Meta Q2 acquired-customer count versus the clean baseline.",
            comparison="scenario_meta_q2_customer_count_vs_clean_baseline",
            expected_relative_change=-0.18,
            tolerance=0.01,
        ),
        GroundTruthMetric(
            id="meta-q2-spend",
            description="Meta Q2 marketing spend versus the clean baseline.",
            comparison="scenario_meta_q2_spend_vs_clean_baseline",
            expected_relative_change=0.07,
            tolerance=0.002,
        ),
        GroundTruthMetric(
            id="meta-q2-cac",
            description="Meta Q2 CAC versus the clean baseline.",
            comparison="scenario_meta_q2_cac_vs_clean_baseline",
            expected_relative_change=0.3049,
            tolerance=0.025,
        ),
        GroundTruthMetric(
            id="meta-q2-90-day-ltv",
            description=(
                "Meta Q2 acquired-customer 90-day LTV versus the clean baseline."
            ),
            comparison="scenario_meta_q2_ltv_vs_clean_baseline",
