"""Frozen evaluator 1.2 evidence semantics copied from revision b7ca12c.

This module is evaluation-only. It reproduces the historical resolver for
offline rescoring of declared scenario 1.0 / evaluator 1.2 workspaces. Runtime,
agent tools, current evaluator checks, and current audit validation must use
``agents.evidence`` instead.
